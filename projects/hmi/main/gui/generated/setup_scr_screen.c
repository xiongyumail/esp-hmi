...
void setup_scr_screen(lv_ui *ui){
	...
	lv_label_set_text(ui->screen_heade_power, LV_SYMBOL_CHARGE);
	...
	lv_label_set_text(ui->screen_heade_net, LV_SYMBOL_WIFI);
	...
	lv_label_set_text(ui->screen_heade_state, LV_SYMBOL_BELL);
